...
2. Audio is sent to an OpenAI-compatible transcription endpoint (Groq by default).
3. Transcript is cleaned up by an LLM with optional app-context awareness (active window, selected text, screenshot via ScreenCaptureKit).
...
- **Provider**: defaults to Groq; any OpenAI-compatible URL works.
