...
struct GeneralSettingsView: View {
    ...
    private var appBuildNumber: String {
        Bundle.main.object(forInfoDictionaryKey: "StroSpeakBuildTag") as? String
    ...
    private var outputLanguageSection: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("When set, Stro Speak translates your speech into the selected language.")
                .font(.caption)
                .foregroundStyle(.secondary)
        }
    }
...
struct PromptsSettingsView: View {
    ...
    private func runSystemPromptTest() {
        ...
        let context = AppContext(
            ...
            bundleIdentifier: "siro.company.strospeak",
