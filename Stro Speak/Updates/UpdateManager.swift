...
final class UpdateManager: ObservableObject {
    ...
    private let releasesURL = URL(string: "https://api.github.com/repos/aaali/Strospeak/releases?per_page=100")!
    ...
    func checkForUpdates(userInitiated: Bool) async {
        let currentBuildTag = Bundle.main.infoDictionary?["StroSpeakBuildTag"] as? String
    ...
    private func performUpdate(downloadURL: URL, expectedSize: Int) async {
        ...
        let tempDir = fm.temporaryDirectory.appendingPathComponent("strospeak-update-\(UUID().uuidString)")
        ...
        let dmgPath = tempDir.appendingPathComponent("Stro Speak.dmg")
        ...
        do {
            ...
            let stagingDir = fm.temporaryDirectory.appendingPathComponent("strospeak-staged-\(UUID().uuidString)")
