...
private let realtimeLog = OSLog(subsystem: "siro.company.strospeak", category: "RealtimeTranscription")
...
final class RealtimeTranscriptionService {
    ...
    private let stateQueue = DispatchQueue(label: "siro.company.strospeak.realtime.state")
