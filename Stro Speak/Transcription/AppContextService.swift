...
"""
    ...
    private func captureActiveWindowScreenshot(
        ...
        do {
            ...
            return (nil, nil, "Could not enumerate windows: \(error.localizedDescription)")
        }
        ...
        guard let display = shareableContent.displays.first else {
            return (nil, nil, "No display available for capture")
        }
        ...
        do {
            ...
            return (nil, nil, "Could not capture screenshot: \(error.localizedDescription)")
        }
